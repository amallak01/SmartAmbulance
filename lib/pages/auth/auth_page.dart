...
import 'package:smart_ambulance/pages/auth/widgets/otp_page.dart';
import 'package:smart_ambulance/pages/auth/widgets/phone_page.dart';
              ...
              : () {
                  if (_phoneController.text.isNotEmpty && state is AuthInitialState) {
                    BlocProvider.of<AuthBloc>(context)
                        .add(PhoneNumberVerificationEvent('+94${_phoneController.text}'));
                    _controller.animateToPage(1, duration: Duration(milliseconds: 400), curve: Curves.easeIn);
                  } else if (state is CodeSentState) {
                    BlocProvider.of<AuthBloc>(context).add(PhoneAuthCodeVerifiedEvent(_otpController.text, state.verificationId, '+94${_phoneController.text}'));
                  }
                },
        ),
      ),
